...
urlpatterns = [
    ...
    path('system-question/interview-question/', views.SystemQuestionIQView.as_view(), name='system-question'),
    path('system-question/interview-question/<int:pk>', views.SystemQuestionIQDetail.as_view, name='system-question-detail'),
    path('system-question/company-question/', views.SystemQuestionCQView.as_view(), name='system-question-CQ'),
    path('system-question/company-question/<int:pk>', views.SystemQuestionCQView.as_view(), name='system-question-CQ-detail'),
