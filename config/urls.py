...
urlpatterns = [
    ...
    path('system-question/IQ/', views.SystemQuestionIQView.as_view(), name='system-question-IQ'),
    path('system-question/CQ/', views.SystemQuestionCQView.as_view(), name='system-question-CQ'),
    path('system-question/<int:pk>', views.SystemQuestionDetail.as_view, name='system-question-detail'),
    path('interview-question/<int:pk>', views.QuestionDetail.as_view(), name='interview-question-detail'),
    path('company-question/<int:pk>', views.QuestionDetail.as_view(), name='company-question-detail'),
